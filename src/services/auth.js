...
export const getWorkLocations = async () => {
	const token = getLocalToken();
	const workLocationsPath = process.env.REACT_APP_WORK_LOCATIONS_API_URL || '/vyonic/v1/work-locations';
	const url = workLocationsPath.startsWith('/') ? workLocationsPath : `/${workLocationsPath}`;
